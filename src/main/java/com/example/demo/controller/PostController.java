...
public class PostController {
  ...
  public ModelAndView write(@ModelAttribute @Valid PostDto.CreateRequest dto, Principal principal) {
  ...
  public ModelAndView read(@RequestParam @NotNull(message="글번호는 필수입력입니다") Long pno, Principal principal) {
    ...
    PostDto.PostResponse post =  postService.read(pno, loginId);
  ...
  public ModelAndView update(@RequestParam @NotNull(message="글번호는 필수입력입니다") Long pno) {
    PostDto.PostResponse post =  postService.read(pno, null);
